...
public class TestBean {
	...
	public void showHindi()
	{
		...
		String m6=ctx.getMessage("errors.range1",new Object[]{"Password","6","12"},"User range is not ok",new Locale("hi"));
	...
	public void showEnglish()
	{
		...
		String m6=ctx.getMessage("errors.range1",new Object[]{"Password","6","12"},"User range is not ok",null);
		System.out.println(m6);
	}
